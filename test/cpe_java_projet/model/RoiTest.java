...
public class RoiTest {
    ...
    public void testIsMoveOk() {
        ...
        Roi instance = new Roi(Couleur.NOIR, new Coord(xFinal, yFinal));
        ...
        expResult.add(true);
        result.add(instance.isMoveOk(4, 5, isCatchOk, isCastlingPossible));
        expResult.add(true);
        result.add(instance.isMoveOk(6, 5, isCatchOk, isCastlingPossible));
        expResult.add(true);
        result.add(instance.isMoveOk(6, 6, isCatchOk, isCastlingPossible));
        expResult.add(true);
        result.add(instance.isMoveOk(4, 6, true, isCastlingPossible));
        expResult.add(true);
        result.add(instance.isMoveOk(6, 4, true, isCastlingPossible));
        expResult.add(true);
        result.add(instance.isMoveOk(4, 4, true, isCastlingPossible));
        expResult.add(false);
        result.add(instance.isMoveOk(5, 7, true, isCastlingPossible));
        expResult.add(false);
        result.add(instance.isMoveOk(5, 3, true, isCastlingPossible));
        expResult.add(false);
        result.add(instance.isMoveOk(3, 5, true, isCastlingPossible));
        expResult.add(false);
        result.add(instance.isMoveOk(7, 5, true, isCastlingPossible));
        expResult.add(false);
    ...
    public void testToString() {
        ...
        int yFinal = 5;
        Roi instance = new Roi(Couleur.NOIR, new Coord(xFinal, yFinal));
        String expResult = "Roi : [x="+xFinal+", y="+yFinal+"]";
